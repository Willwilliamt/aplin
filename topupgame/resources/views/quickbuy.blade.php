    ...
    <div class="container box mt-5 p-5">
        ...
        <div class="order-info">
            ...
            <form action="{{ url('/purchase', ['id' => $game->id_game]) }}" method="POST">
                ...
                <div class="mb-3">
                    <label for="zoneId" class="form-label"><strong>Zone ID</strong></label>
                    <input type="text" class="form-control" id="zoneId" name="zone_id" placeholder="Contoh: 2020. Tanpa tanda kurung" required>
                </div>
                <div class="mb-3">
                    <label for="note" class="form-label"><strong>Catatan untuk Penjual (Optional)</strong></label>
                ...
                <button type="submit" class="btn btn-success"><strong>Beli Sekarang</strong></button>
            </form>
        </div>
    </div>
</body>
