...
<body>
    <div class="d-flex justify-content-center" style="height: 100vh; align-items: flex-start; padding-top: 10vh;">
        <div class="container box">
            <h1 class="text-center text-white">Update Influencer</h1>
            <hr />
            <form action="{{ route('influencer.update', $promo->Id_influencer) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col mb-3">
                        <label class="form-label"><strong>ID</strong></label>
                        <input type="text" name="id" class="form-control" value="{{ $promo->Id_influencer }}" readonly>
                    </div>
                    <div class="col mb-3">
                        <label class="form-label"><strong>Nama</strong></label>
                        <input type="text" name="nama" class="form-control" value="{{ $promo->Nama_influencer }}">
                    </div>
                </div>
                <div class="row">
                    <div class="col mb-3">
